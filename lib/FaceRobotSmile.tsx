...
const FaceRobotSmile = (props: SVGProps<SVGSVGElement>) => (
    <svg
    ...
    >
        <g fill="currentColor" clipPath="url(#a)">
            <path d="M9.238 9.451a.75.75 0 1 1 1.024 1.096 3.316 3.316 0 0 1-4.524.004.75.75 0 0 1 1.024-1.097 1.816 1.816 0 0 0 2.476-.003M6.25 5.5a.75.75 0 0 1 .75.75v1a.75.75 0 0 1-1.5 0v-1a.75.75 0 0 1 .75-.75m3.5 0a.75.75 0 0 1 .75.75v1a.75.75 0 0 1-1.5 0v-1a.75.75 0 0 1 .75-.75" />
            <path
                fillRule="evenodd"
