...
const CrownDiamond = (props: SVGProps<SVGSVGElement>) => (
    ...
    >
        <g fill="currentColor" fillRule="evenodd" clipRule="evenodd">
            <path d="m8.427 11.073 1.205-1.205a.4.4 0 0 0 .118-.285.8.8 0 0 0-.236-.569L8.427 7.927a.603.603 0 0 0-.854 0L6.486 9.014a.8.8 0 0 0-.236.57c0 .106.042.208.118.284l1.205 1.205a.604.604 0 0 0 .854 0" />
